...
// Fotos de producto — URLs oficiales de nutrevo.cl (wp-content/uploads)
const NV_PHOTOS: Record<string, string> = {
  activa2:    'https://nutrevo.cl/wp-content/uploads/2025/10/ALFAJORAIWEB-600x750.webp',
  moroketo:   'https://nutrevo.cl/wp-content/uploads/2026/04/MOROKETO_WEB12-1FINAL-600x750.webp',
  volki_coco: 'https://nutrevo.cl/wp-content/uploads/2025/10/VOLKI-KETO1WEB-600x750.webp',
}
...
export const NUTREVO_PRODUCTS: NutrievoProduct[] = [
  ...
  // ── PRODUCTOS DESTACADOS — Marketplace Centro Metabólico ─────────────────
  {
    ...
    disponible: true,
    url: 'https://nutrevo.cl/producto/alfajores-de-proteinas/',
    foto: NV_PHOTOS.activa2,
    esDestacado: true,
  },
  {
    ...
    foto: NV_PHOTOS.moroketo,
    esDestacado: true,
  },
  {
    id: 'volki-coco',
    nombre: 'Volki de Coco',
    categoria: 'snack_keto',
    precio: 3600,
    proteina: 3,
    kcal: 129,
    descripcion: 'Cookie keto de coco orgánico con base de almendra y cobertura de chocolate 85% cacao. Pack de 2 unidades. Vegano, sin azúcar, sin gluten, sin lácteos, sin huevo ni soya.',
    claimPorObjetivo: {
      perdida_grasa: 'El dulce del déficit: keto, sin azúcar y apto para cualquier restricción — sin salirte del plan.',
      keto: 'Coco orgánico + chocolate 85% + sin azúcar: el snack keto más limpio para tu colación.',
      salud_digestiva: 'Sin gluten, sin lácteos, sin huevo, sin soya — apto para los que cuidan cada ingrediente.',
      bienestar_general: 'Disfruta un dulce de verdad sin azúcar, 100% vegano y con cero ingredientes de relleno.',
    },
    ingredientes: ['Coco orgánico', 'Harina de almendra', 'Chocolate 85% cacao', 'Alulosa'],
    beneficios: [
      '100% vegano',
      'Sin azúcar ni sucralosa',
      'Sin gluten',
      'Sin lácteos, huevo ni soya',
      'Apto dieta keto',
      'Chocolate 85% cacao real',
    ],
    objetivos: ['perdida_grasa', 'keto', 'salud_digestiva', 'bienestar_general'],
    sinGluten: true,
    sinLactosa: true,
    vegano: true,
    sinAzucarAnadida: true,
    disponible: true,
    url: 'https://nutrevo.cl/producto/volkis-de-coco/',
    foto: NV_PHOTOS.volki_coco,
    esDestacado: true,
  },
